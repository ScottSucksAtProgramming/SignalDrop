        ...
        Form {
                ...
                VStack(spacing: 8) {
                    if let icon = NSImage(named: NSImage.applicationIconName) {
                        Image(nsImage: icon)
                            ...
                            .accessibilityLabel(String(localized: "SignalDrop app icon"))
                    }
                    Text(String(localized: "SignalDrop"))
                        .font(.title2.bold())
                    Text(versionString)
                        .font(.caption)
            ...
            Section {
                AboutLinkRow(
                    ...
                    detail: "github.com",
                    url: "https://github.com/ScottSucksAtProgramming/SignalDrop"
                )
                AboutLinkRow(
                    icon: "person",
                    iconColor: .purple,
                ...
                AboutLinkRow(
                    ...
                    detail: "GitHub",
                    url: "https://github.com/ScottSucksAtProgramming/SignalDrop/issues"
                )
            }
        }
        .formStyle(.grouped)
